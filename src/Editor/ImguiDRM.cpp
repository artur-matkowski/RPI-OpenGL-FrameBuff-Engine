...
/*
	    ...
	    if (install_callbacks)
	    {
	        ...
	        g_PrevUserCallbackMousebutton = glfwSetMouseButtonCallback(window, ImGui_ImplDRM_MouseButtonCallback);
	        g_PrevUserCallbackScroll = glfwSetScrollCallback(window, ImGui_ImplDRM_ScrollCallback);
	        g_PrevUserCallbackKey = glfwSetKeyCallback(window, ImGui_ImplDRM_KeyCallback);
	        g_PrevUserCallbackChar = glfwSetCharCallback(window, ImGui_ImplDRM_CharCallback);
	        g_PrevUserCallbackMonitor = glfwSetMonitorCallback(ImGui_ImplDRM_MonitorCallback);
	    }
*/
	    // Update monitors the first time (note: monitor callback are broken in GLFW 3.2 and earlier, see github.com/glfw/glfw/issues/784)
	    ImGui_ImplDRM_UpdateMonitors();
	    //glfwSetMonitorCallback(ImGui_ImplDRM_MonitorCallback);
...
/*
	    ...
	    glfwSetMouseButtonCallback(data->Window, ImGui_ImplDRM_MouseButtonCallback);
	    glfwSetScrollCallback(data->Window, ImGui_ImplDRM_ScrollCallback);
	    glfwSetKeyCallback(data->Window, ImGui_ImplDRM_KeyCallback);
	    glfwSetCharCallback(data->Window, ImGui_ImplDRM_CharCallback);

	    glfwSetWindowCloseCallback(data->Window, ImGui_ImplDRM_WindowCloseCallback);
	    glfwSetWindowPosCallback(data->Window, ImGui_ImplDRM_WindowPosCallback);
	    glfwSetWindowSizeCallback(data->Window, ImGui_ImplDRM_WindowSizeCallback);
	...
	{
		log::debug << "ImGui_ImplDRM_SetWindowFocus" << std::endl;
	}
	...
	{
		//log::debug << "ImGui_ImplDRM_GetWindowMinimized" << std::endl;
		return false;
	}
	...
	static void ImGui_ImplDRM_InitPlatformInterface()
	{
	    ...
	    platform_io.Platform_CreateWindow 			= ImGui_ImplDRM_CreateWindow;
	    platform_io.Platform_DestroyWindow 			= ImGui_ImplDRM_DestroyWindow;
	    platform_io.Platform_ShowWindow 			= ImGui_ImplDRM_ShowWindow;
	    platform_io.Platform_SetWindowPos 			= ImGui_ImplDRM_SetWindowPos;
	    platform_io.Platform_GetWindowPos 			= ImGui_ImplDRM_GetWindowPos;
	    platform_io.Platform_SetWindowSize 			= ImGui_ImplDRM_SetWindowSize;
	    platform_io.Platform_GetWindowSize 			= ImGui_ImplDRM_GetWindowSize;
	    platform_io.Platform_SetWindowFocus 		= ImGui_ImplDRM_SetWindowFocus;
	    platform_io.Platform_GetWindowFocus 		= ImGui_ImplDRM_GetWindowFocus;
	    platform_io.Platform_GetWindowMinimized 	= ImGui_ImplDRM_GetWindowMinimized;
	    platform_io.Platform_SetWindowTitle 		= ImGui_ImplDRM_SetWindowTitle;
	    platform_io.Platform_RenderWindow 			= ImGui_ImplDRM_RenderWindow;
	    platform_io.Platform_SwapBuffers 			= ImGui_ImplDRM_SwapBuffers;
	...
	void ImGui_ImplDRM_NewFrame()
	{
	    ...
	    ImGui_ImplDRM_UpdateMousePosAndButtons();
	    //ImGui_ImplDRM_UpdateMouseCursor();

	    // Update game controllers (if enabled and available)
	    //ImGui_ImplDRM_UpdateGamepads();
	}

	void ImGui_ImplDRM_Shutdown()
	{
	    // Cleanup
	...
	static const char* ImGui_ImplDRM_GetClipboardText(void* user_data)
	{
	    return "TBD https://github.com/exebook/x11clipboard/blob/master/x11copy.c";
	}

	static void ImGui_ImplDRM_SetClipboardText(void* user_data, const char* text)
	{
