...
namespace asapi
{
	constexpr struct KeyMapsXlib
	{
		asapi::keycodes		m_keyCodeMap[1+(int)asapi::keycodes::unknown] = {asapi::keycodes::unknown};
		char 				m_keycodes2char[255] = {0};
		asapi::mousecodes 	m_mouseCodeMap[5] = {asapi::mousecodes::unknown};

		constexpr KeyMapsXlib()
		{
			...
			m_keycodes2char[ (int) asapi::keycodes::snapi_esc ]						= (char)27; //escape
			m_keycodes2char[ (int) asapi::keycodes::snapi_1 ]						= '1';
			m_keycodes2char[ (int) asapi::keycodes::snapi_2 ]						= '2';
			m_keycodes2char[ (int) asapi::keycodes::snapi_3 ]						= '3';
			m_keycodes2char[ (int) asapi::keycodes::snapi_4 ]						= '4';
			m_keycodes2char[ (int) asapi::keycodes::snapi_5 ]						= '5';
			m_keycodes2char[ (int) asapi::keycodes::snapi_6 ]						= '6';
			m_keycodes2char[ (int) asapi::keycodes::snapi_7 ]						= '7';
			m_keycodes2char[ (int) asapi::keycodes::snapi_8 ]						= '8';
			m_keycodes2char[ (int) asapi::keycodes::snapi_9 ]						= '9';
			m_keycodes2char[ (int) asapi::keycodes::snapi_0 ]						= '0';
			m_keycodes2char[ (int) asapi::keycodes::snapi_minus ]					= '-';
			m_keycodes2char[ (int) asapi::keycodes::snapi_equal ]					= '=';
			m_keycodes2char[ (int) asapi::keycodes::snapi_backspace ]				= (char)8; //backspace
			m_keycodes2char[ (int) asapi::keycodes::snapi_q ]						= 'q';
			m_keycodes2char[ (int) asapi::keycodes::snapi_w ]						= 'w';
			m_keycodes2char[ (int) asapi::keycodes::snapi_e ]						= 'e';
			m_keycodes2char[ (int) asapi::keycodes::snapi_r ]						= 'r';
			m_keycodes2char[ (int) asapi::keycodes::snapi_t ]						= 't';
			m_keycodes2char[ (int) asapi::keycodes::snapi_y ]						= 'y';
			m_keycodes2char[ (int) asapi::keycodes::snapi_u ]						= 'u';
			m_keycodes2char[ (int) asapi::keycodes::snapi_i ]						= 'i';
			m_keycodes2char[ (int) asapi::keycodes::snapi_o ]						= 'o';
			m_keycodes2char[ (int) asapi::keycodes::snapi_p ]						= 'p';
			m_keycodes2char[ (int) asapi::keycodes::snapi_leftbrace ]				= '{';
			m_keycodes2char[ (int) asapi::keycodes::snapi_rightbrace ]				= '}';
			m_keycodes2char[ (int) asapi::keycodes::snapi_enter ]					= '\n';
			m_keycodes2char[ (int) asapi::keycodes::snapi_a ]						= 'a';
			m_keycodes2char[ (int) asapi::keycodes::snapi_s ]						= 's';
			m_keycodes2char[ (int) asapi::keycodes::snapi_d ]						= 'd';
			m_keycodes2char[ (int) asapi::keycodes::snapi_f ]						= 'f';
			m_keycodes2char[ (int) asapi::keycodes::snapi_g ]						= 'g';
			m_keycodes2char[ (int) asapi::keycodes::snapi_h ]						= 'h';
			m_keycodes2char[ (int) asapi::keycodes::snapi_j ]						= 'j';
			m_keycodes2char[ (int) asapi::keycodes::snapi_k ]						= 'k';
			m_keycodes2char[ (int) asapi::keycodes::snapi_l ]						= 'l';
			m_keycodes2char[ (int) asapi::keycodes::snapi_semicolon ]				= ';';
			m_keycodes2char[ (int) asapi::keycodes::snapi_apostrophe ]				= '\'';
			m_keycodes2char[ (int) asapi::keycodes::snapi_grave ]					= '`';
			m_keycodes2char[ (int) asapi::keycodes::snapi_backslash ]				= '\\';
			m_keycodes2char[ (int) asapi::keycodes::snapi_z ]						= 'z';
			m_keycodes2char[ (int) asapi::keycodes::snapi_x ]						= 'x';
			m_keycodes2char[ (int) asapi::keycodes::snapi_c ]						= 'c';
			m_keycodes2char[ (int) asapi::keycodes::snapi_v ]						= 'v';
			m_keycodes2char[ (int) asapi::keycodes::snapi_b ]						= 'b';
			m_keycodes2char[ (int) asapi::keycodes::snapi_n ]						= 'n';
			m_keycodes2char[ (int) asapi::keycodes::snapi_m ]						= 'm';
			m_keycodes2char[ (int) asapi::keycodes::snapi_comma ]					= ',';
			m_keycodes2char[ (int) asapi::keycodes::snapi_dot ]						= '.';
			m_keycodes2char[ (int) asapi::keycodes::snapi_slash ]					= '/';
			m_keycodes2char[ (int) asapi::keycodes::snapi_kpasterisk ]				= '*';
			m_keycodes2char[ (int) asapi::keycodes::snapi_space ]					= ' ';
			m_keycodes2char[ (int) asapi::keycodes::snapi_kp7 ]						= '7';
			m_keycodes2char[ (int) asapi::keycodes::snapi_kp8 ]						= '8';
			m_keycodes2char[ (int) asapi::keycodes::snapi_kp9 ]						= '9';
			m_keycodes2char[ (int) asapi::keycodes::snapi_kpminus ]					= '-';
			m_keycodes2char[ (int) asapi::keycodes::snapi_kp4 ]						= '4';
			m_keycodes2char[ (int) asapi::keycodes::snapi_kp5 ]						= '5';
			m_keycodes2char[ (int) asapi::keycodes::snapi_kp6 ]						= '6';
			m_keycodes2char[ (int) asapi::keycodes::snapi_kpplus ]					= '+';
			m_keycodes2char[ (int) asapi::keycodes::snapi_kp1 ]						= '1';
			m_keycodes2char[ (int) asapi::keycodes::snapi_kp2 ]						= '2';
			m_keycodes2char[ (int) asapi::keycodes::snapi_kp3 ]						= '3';
			m_keycodes2char[ (int) asapi::keycodes::snapi_kp0 ]						= '0';
			m_keycodes2char[ (int) asapi::keycodes::snapi_kpdot ]					= ',';
	...
	void Xlib_EGL_ContextType::HandleContextEvents()
	{
		...
		while( XPending(m_XDisplay.display) )
		{
			...
			case ButtonPress:	
		    	...
		    	{
					mouseClickEvent.m_key = (int)keyMapsXlib.m_mouseCodeMap[event.xbutton.button];
					mouseClickEvent.m_state = (int)asapi::keystates::snapi_down;
		    	}
			...
			case KeyPress:
				...
				if(event.xkey.keycode < (int)asapi::keycodes::unknown){
					key = (int)keyMapsXlib.m_keyCodeMap[(int)event.xkey.keycode];
				}

		    	keyboardEvent.m_key = (int)key; 
		    	keyboardEvent.m_state = (int)asapi::keystates::snapi_down; 
		    	keyboardEvent.m_char = (char)keyMapsXlib.m_keycodes2char[ key ];
				#ifdef IS_EDITOR
